...
<<<<<<< HEAD:review/10-functions-201/1-fill-in-the-blanks/README.md
> 6/19/2020, 2:30:45 PM 
=======
> 6/21/2020, 9:05:10 AM 
>>>>>>> d7a0df91cdbeaabba9264cb3ac7fe6f23377b6f6:review/12-functions-301/1-fill-in-the-blanks/README.md
...
const _3_expect = 4;
const _3_actual = add(2, 2);
console.assert(_3_actual === _3_expect, 'Test 3');

const _4_expect = 8;
const _4_actual = add(5, 3);
console.assert(_4_actual === _4_expect, 'Test 4');

const _5_expect = 10;
const _5_actual = add(5, 5);
console.assert(_5_actual === _5_expect, 'Test 5');

const _6_expect = 6;
const _6_actual = add(2, 4);
console.assert(_6_actual === _6_expect, 'Test 6');

const _7_expect = 54;
const _7_actual = add(27, 27);
console.assert(_7_actual === _7_expect, 'Test 7');

const _8_expect = 0;
const _8_actual = add(0, 0);
console.assert(_8_actual === _8_expect, 'Test 8');

const _9_expect = 1;
const _9_actual = add(0, 1);
...
const sameTruthiness = (a, b) => {
  // no need to check a or b, they can be any type
  const first = Boolean(a) 
  const second = Boolean(b) 
