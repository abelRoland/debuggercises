...
const greaterThanOrEqualTo = (left, right) => (typeof left === 'string' && typeof right === 'string') 
? (left === right)
: (+left >= +right);
...
const greaterThan = (left, right) => (typeof left === 'string' && typeof right === 'string') 
? (left === right)
: (+left > +right);
...
const lessThanOrEqualTo = (left, right) => (typeof left === 'string' && typeof right === 'string') 
? (left === right)
: (+left <= +right);
...
const lessThan = (left, right) => (typeof left === 'string' && typeof right === 'string') 
? (left === right)
: (+left < +right);
